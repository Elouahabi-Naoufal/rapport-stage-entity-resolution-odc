...
C'est dans ce cadre que l'\textbf{Office des Changes (OC)}, placé sous la tutelle du Ministère de l'Économie et des Finances, joue un rôle central. Pour accomplir ses missions statistiques et réglementaires, il s'appuie sur une base de données volumineuse — la table \texttt{RFF.formule\_T\_clean} — alimentée par les déclarations bancaires transmises par les établissements de crédit via le Répertoire des Flux Financiers (RFF).
