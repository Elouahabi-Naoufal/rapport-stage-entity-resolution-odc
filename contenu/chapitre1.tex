...
\begin{ganttchart}[
    ...
    bar label node/.append style={align=right, text width=3.2cm},
    group label node/.append style={align=right, text width=3.2cm},
    milestone label node/.append style={align=right, text width=3.2cm},
